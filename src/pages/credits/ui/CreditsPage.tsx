...
const THANKS_ITEMS = [
  ...
  "인덕대학교 웹 개발 동아리 Modern Agile Team의 모든 분들께",
    ...
    <div className={styles.creditsPage}>
      ...
      <section className={styles.essaySection} aria-labelledby="reason-title">
        ...
        <div className={styles.essayBox}>
          <p>처음에는 게임을 할 줄밖에 몰랐다.</p>
          <p>
            게임을 하는 시간이면, 나는 항상 편안했고 즐거웠다. 현실의 고단함에서
            잠시 벗어날 수 있었다.
          </p>
          <p>
          ...
          <p>
            거창한 이야기지만, Git을 공부하는 모든 사람들이 꼬깃을 즐기는
            동안에는 잠시나마 편안함과 즐거움을 느낄 수 있기를 바란다.
          </p>
        </div>
      </section>
